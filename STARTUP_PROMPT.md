...
`stfs v2.6` TradingView Pine indicator outputs are pasted into the sidebar manually (one snapshot per session). The regime module (`scanner/regime.py`) applies:
...
7. `scanner/regime.py` (stfs v2.6 → multipliers)
