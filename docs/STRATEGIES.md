...
**Source**: docs/reference/buddy_app.py (originally SPX Live Calendar Scanner v1.3-1.5)
...
- `regime_score` — multiplier from stfs v2.6 snapshot (1.0 = neutral; 0 = hard skip)
