...
# ---------------------------------------------------------------------------
# Regime snapshot (from STFS v2.7)
# ---------------------------------------------------------------------------

@dataclass
class RegimeSnapshot:
    """Minimal snapshot of STFS v2.7 outputs.
    ...
    stfs_score_a14: int = 50
    stfs_score_flyagonal: int = 50
    stfs_score_triple: int = 50         # no direct STFS score; default neutral or map manually.
